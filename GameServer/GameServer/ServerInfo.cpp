...
void CServerInfo::ReadCharacterInfo(char* section, char* path) // OK
{
	...
	this->MASTERY_OPTION_BOSS_DAMAGE_INCREASE_2 = GetPrivateProfileInt(section, "MASTERY_OPTION_BOSS_DAMAGE_INCREASE_2", 30, path);
	...
	this->MASTERY_BONUS_FREEZING_DAMAGE = GetPrivateProfileInt(section, "MASTERY_BONUS_FREEZING_DAMAGE", 3, path);
}
...
void CServerInfo::ReadCommonInfo(char* section, char* path) // OK
{
	...
	this->m_OficinaNpcIndex = GetPrivateProfileInt(section, "OficinaNpcIndex", 0, path);
