...
public:
	...
	void WingSprite(LPOBJ lpObj,LPOBJ lpTarget,long long* damage);
	void HelperSprite(LPOBJ lpObj,LPOBJ lpTarget,long long* damage);
	...
	void AttackBoss(LPOBJ lpObj, LPOBJ lpTarget, CSkill* lpSkill);
	void AttackBossElemental(LPOBJ lpObj, LPOBJ lpTarget, CSkill* lpSkill);
